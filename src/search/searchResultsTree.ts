        ...
        vscode.TreeDataProvider<SearchNode<SearchNodeKind>>
{
    ...
    public async searchBarValueWasUpdated (
        ...
        return vscode.window.withProgress<void>({
            ...
            const iterativeRefresh = (currentTree: SearchNode<SearchContainerNode>[] | null) => {
            ...
            const finalTree = await searchNodeGenerator.refreshResults(results, useMatchTitles, useMatchNodeDescriptions, cancellationToken, iterativeRefresh);
            ...
            this.refresh(finalTree || undefined);
            this.searchResultsView.updateDecoationsIfViewIsVisible();
        });
    }
