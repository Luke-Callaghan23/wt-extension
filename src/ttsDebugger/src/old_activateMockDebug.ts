...
import { MockDebugSession } from './old_mockDebug';
import { FileAccessor } from './old_mockRuntime';
...
export function activateMockDebug(context: vscode.ExtensionContext, factory?: vscode.DebugAdapterDescriptorFactory) {
	...
	context.subscriptions.push(vscode.languages.registerEvaluatableExpressionProvider('wt', {
	...
	context.subscriptions.push(vscode.languages.registerInlineValuesProvider('wt', {
